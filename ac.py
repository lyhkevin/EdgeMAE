...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--img_save_path', type=str,default='./snapshot/ac/')
        self.parser.add_argument('--weight_save_path', type=str,default='./weight/ac/')
        ...
        self.parser.add_argument("--log_path", default='./log/accelerate.log')
...
mae, train_loader,optimizer = accelerator.prepare(mae, train_loader,optimizer)
